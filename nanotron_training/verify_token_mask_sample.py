...
def main() -> None:
    ...
    if not (tokenizer_dir / "dna_config.json").exists():
    ...
    if tokenizer.k != args.k:
        raise ValueError(f"k mismatch: tokenizer.k={tokenizer.k}, expected --k={args.k}")
    ...
    print(f"tokenizer.k={tokenizer.k}")
    print(f"dna_kmer_start_id={tokenizer.dna_kmer_start_id}")
    print(f"dna_kmer_end_id={tokenizer.dna_kmer_end_id}")
    print("Suggested exports:")
    print(f"  export HYBRID_BP_DNA_KMER_START_ID={tokenizer.dna_kmer_start_id}")
    print(f"  export HYBRID_BP_DNA_KMER_END_ID={tokenizer.dna_kmer_end_id}")
    print(f"  export HYBRID_BP_K={tokenizer.k}")
